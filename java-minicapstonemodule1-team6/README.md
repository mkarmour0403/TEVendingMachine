...
with a list of all items in the vending machine with its quantity remaining:
    ...
    - Every product is initially stocked to the starting quantity from the input file, but not more than maximum amount.
...
7. The purchase process flow is as follows:
    ...
    purchase.
        ...
        remaining. Dispensing also returns a message:
          ...
          - All cat items print "Purr, Purr, Meow!"
...
8. The vending machine logs all transactions to prevent theft from the vending machine.
   ...
   - The lines must follow the format shown in the following example.
       ...
       - The second dollar amount is the new balance.
        ```
        03/01/2024 12:00:00 PM FEED MONEY: $5.00 $5.00 
        03/01/2024 12:00:15 PM FEED MONEY: $5.00 $10.00 
        03/01/2024 12:00:20 PM Emperor Penguin B4 $1.75 $8.25 
        03/01/2024 12:01:25 PM Unicorn Pony D2 $1.50 $6.75 
        03/01/2024 12:01:35 PM GIVE CHANGE: $6.75 $0.00
        ```
...
| Starting Qty  | The quantity of this item loaded when we start.                    |

For example:

```
A1,Yellow Duck,3.05,Duck,4
B1,Emperor Penguin,1.80,Penguin,5
B2,Macaroni Penguin,1.50,Penguin,5
C1,Black Cat,1.25,Cat,3
```
